    ...
    <div className="fade-in">
      ...
      <div className="dashboard-card" style={{ marginBottom: '2rem' }}>
        <div className="card-header">
          ...
          <div className="card-title">Kwala Quest Automation</div>
        </div>
        <div className="card-content">
          ...
          <p>
            Kwala monitors your on-chain activities 24/7 and automatically completes quests when requirements are met. 
